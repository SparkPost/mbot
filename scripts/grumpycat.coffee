...
#
# Local Mods:
#   Exclude the bomb, replace a couple of the photos
...
cats = [
  ...
  "http://mlkshk.com/r/X96V.gif", # Good neighbor
  "http://mlkshk.com/r/X96U.gif", # Need a hug
  "http://mlkshk.com/r/X96T.gif", # Problem with people
  "http://mlkshk.com/r/X96S.gif", # Fun once
  "http://mlkshk.com/r/X96R.gif", # Fluffy
  "http://mlkshk.com/r/X96Q.gif", # Shovel
  "http://mlkshk.com/r/X977.gif"  # No
]
